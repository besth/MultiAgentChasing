...
class Reset():
    def __init__(self, modelName, qPosInitNoise=0, qVelInitNoise=0):
...
class TransitionFunctionNaivePredator():
    ...
    def __call__(self, allAgentOldState, preyAction, renderOpen = False):
        ...
        # Hacking
        #allAgentOldQVel[0] = 10
        #allAgentOldQVel[1] = 0
        #allAgentAction[0:2] = [0, 0]
